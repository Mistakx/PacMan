...
public class Level1 extends Level {
  ...
  protected void leaveTheBox(Enemy enemy) {
    // The enemies leave the spawning box at the beginning of a level, and after they're eaten by a powered up player
  ...
  private void enemiesTeleportWalls() {
    ...
    for (int i = 0; i < 6; i++) {
      ...
      // Right teleport
      else if ((tempEnemy.getX() == 36 - 4) && (tempEnemy.getY() == 17)) {
  ...
  private void playersTeleportWalls() {
    ...
    for (int i = 0; i < 2; i++) {
      ...
      // Left teleport
      if ((tempPlayer.getX() == 3) && (tempPlayer.getY() == 17)) {
        tempPlayer.setLocation(36 - 5, tempPlayer.getY());
        Greenfoot.playSound("teleport.mp3");
      }
      // Right teleport
      else if ((tempPlayer.getX() == 36 - 4) && (tempPlayer.getY() == 17)) {
